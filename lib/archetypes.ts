...
export const ARCHETYPES: Record<ArchetypeId, Archetype> = {
  ...
  librarian: {
    ...
    description: "You want depth, nuance, and completeness. Don't pre-filter, don't summarize, don't leave things out because you think they're not relevant. Give you the full picture \u2014 sources, edge cases, caveats, context \u2014 and you'll sort through it yourself.",
    color: '#0891B2',
    icon: '\uD83D\uDCDA',
  },
  closer: {
